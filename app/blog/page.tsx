...
export const metadata: Metadata = {
  title: "Блог",
  description: "Практические материалы по эксплуатации Windows-инфраструктуры, сетям, виртуализации и ИБ."
};
  ...
  return (
    <section className="container py-16">
      ...
      <p className="mt-4 max-w-2xl text-slate-300">
        Короткие практические заметки по администрированию, сетям, ИБ и поддержке критичных рабочих
        процессов.
      </p>
